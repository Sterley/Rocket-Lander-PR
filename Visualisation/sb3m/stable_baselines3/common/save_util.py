...
from ...stable_baselines3.common import utils #get_device, get_system_info
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(save_path, mode="w") as archive:
        ...
        archive.writestr("system_info.txt", utils.get_system_info(print_info=False)[1])
...
def load_from_zip_file(
    ...
    device = utils.get_device(device=device)
